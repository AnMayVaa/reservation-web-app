// ABI for PremiumHotel v2 Smart Contract
// Generated from contracts/PremiumHotel.sol (pragma ^0.8.20)
...
export const PREMIUM_HOTEL_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "receptionist", type: "address" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "remainingContractBalance", type: "uint256" },
    ],
    name: "FundsWithdrawn",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "string", name: "roomType", type: "string" },
    ],
    name: "RoomAdded",
    type: "event",
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "enum PremiumHotel.RoomStatus", name: "status", type: "uint8" },
          { internalType: "address", name: "occupant", type: "address" },
          { internalType: "uint256", name: "bookingTime", type: "uint256" },
          { internalType: "string", name: "name", type: "string" },
          { internalType: "string", name: "roomType", type: "string" },
  ...
  // ── Owner Write Functions ─────────────────────────────────
  {
    inputs: [
      ...
      { internalType: "string", name: "_roomType", type: "string" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_roomId", type: "uint256" },
      { internalType: "bool", name: "_refundOccupant", type: "bool" },
    ],
    name: "forceResetRoom",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "address", name: "_receptionist", type: "address" }],
