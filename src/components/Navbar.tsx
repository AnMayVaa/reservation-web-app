        ...
        <div className="flex items-center gap-3 sm:gap-4">
          {isContractConfigured && (
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-slate-900 border border-slate-800 text-xs text-slate-400 hover:text-amber-400 hover:border-slate-700 transition-colors"
            >
